...
to change the column automatically - but it does not!  This is because everything that happens "inside" the function cannot change the status of objects *outside* the function.
